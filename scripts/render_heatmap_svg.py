...
def render_heatmap():
    ...
    for idx, day in enumerate(days):
        ...
        # Staggered animation delay based on week + dow
        delay = round((week * 0.015) + (dow * 0.02), 3)
  ...
  <style>
    ...
    .title {{ font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; font-size: 13px; font-weight: 600; fill: #58a6ff; }}
